...
// C.S.V. BEACON – MAI dashboard compatibility shim
// PLA-03F: dashboard card and area-home shortcuts are now native/stable.

(() => {
  "use strict";

  const BUILD = "MAI-DASH-SHIM-PLA03F-20260512-1";

  function cardVisible() {
    const card = document.querySelector('[data-card="mooring_anchoring_inventories"]');

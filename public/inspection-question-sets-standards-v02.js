// public/inspection-question-sets-standards-v02.js
// C.S.V. BEACON — Inspection & Assurance Question Sets standards/mobile polish v02.
// Display-only page polish. No database writes, no auth changes, no calculation changes.

(() => {
  "use strict";

  const BUILD = "INSPECTION-QUESTION-SETS-STANDARDS-V02-20260601";
  ...
  function injectStyle() {
    if (document.getElementById("csvbInspectionQsStandardsV02Style")) return;

    const style = document.createElement("style");
    style.id = "csvbInspectionQsStandardsV02Style";
    style.textContent = `
      body{
